...
import com.next.PagerSlidingTabStrip;
import com.next.PagerSlidingTabStrip.IconTabProvider;
...
public class QuickContactFragment extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		BadgeView badge = new BadgeView(getActivity(), targetView);
		badge.setWidth(dp2px(getActivity(), 8));
		badge.setHeight(dp2px(getActivity(), 8));
